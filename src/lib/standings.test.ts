...
const teams: Team[] = [
	{ id: 'a', group: 'A', name: { es: 'A', en: 'A' }, code: 'AAA', flag: '', ranking: 1 },
	{ id: 'b', group: 'A', name: { es: 'B', en: 'B' }, code: 'BBB', flag: '', ranking: 2 },
	{ id: 'c', group: 'A', name: { es: 'C', en: 'C' }, code: 'CCC', flag: '', ranking: 3 },
];

describe('calculateStandings', () => {
	it('treats current live scores as provisional final results', () => {
		const matches: Match[] = [
			{ id: '1', group: 'A', homeId: 'a', awayId: 'b', homeGoals: 1, awayGoals: 0, minute: 52, status: 'live' },
			{ id: '2', group: 'A', homeId: 'c', awayId: 'a', homeGoals: 0, awayGoals: 0, minute: 90, status: 'finished' },
		];
	...
	it('reorders teams immediately after a simultaneous-match goal', () => {
		const before: Match[] = [
			{ id: '1', group: 'A', homeId: 'a', awayId: 'b', homeGoals: 0, awayGoals: 0, minute: 70, status: 'live' },
			{ id: '2', group: 'A', homeId: 'c', awayId: 'a', homeGoals: 0, awayGoals: 0, minute: 69, status: 'live' },
		];
